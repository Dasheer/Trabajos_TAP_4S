package ejercicios1p.java.ejercicio4;
...
public class Menuv4p1 extends Frame implements ActionListener {
    ...
    public void initComponents() {
        ...
        /*
         * panel_superior = new Panel(); panel_central = new Panel(); panel_inferior =
         * new Panel();
         */

        /*
         * panel_central.setLayout(new BorderLayout()); panel_superior.setLayout(new
         * BorderLayout()); panel_inferior.setLayout(new BorderLayout());
         */
         ...
         * panel_superior.add(txt_ini, BorderLayout.CENTER); panel_superior.add(lbl_msg,
         * BorderLayout.WEST); panel_central.add(txt_out, BorderLayout.CENTER);
         * panel_inferior.add(btn_clear, BorderLayout.EAST); this.add(panel_superior,
         * BorderLayout.NORTH); this.add(panel_inferior, BorderLayout.SOUTH);
